...
module.exports = function(pathToData, data, libConfig, lang) {
    ...
    return platforms.reduce(function(result, platform, index, array) {
        ...
        var l = lang === 'en' ? '' : lang;
        result[platform] = {
            readme: versionData.readme && versionData.readme[l],
            changelog: versionData.changelog && versionData.changelog[l],
            migration: versionData.migration && versionData.migration[l],
            blocks: blocksResult
        };
